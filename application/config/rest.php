...
$config['rest_valid_logins'] = array('admin' => 'admin',"zeros"=>"toor");
...
|
*/
$config['rest_ip_whitelist'] = '192.168.8.157, 192.168.8.168, 0.0.0.0, 127.0.0.1, 201.219.220.37, 190.131.220.178';
